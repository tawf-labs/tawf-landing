    ...
    <section id="ecosystem" className="relative py-16 sm:py-20 md:py-28 w-full overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 w-full max-w-[100vw]">
        ...
        <div className="relative w-full overflow-hidden">
          <div className="absolute inset-y-0 left-0 w-16 md:w-24 bg-transparent z-10 pointer-events-none" />
          <div className="absolute inset-y-0 right-0 w-16 md:w-24 bg-transparent z-10 pointer-events-none" />
